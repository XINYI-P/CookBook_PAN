...
public class CookBookApp {
	...
	private static Recipe createGongBaoJiding() {
		Recipe recipe = new Recipe("Gong Bao Jiding", "Sichuan Dish", 6);		
	...
	private static Recipe createxindecai() {
		Recipe recipe = new Recipe("xindecai", "Sichuan Dish", 2);		
	...
	public static void main(String[] args) {
		...
		cb.add(createxindecai());
		
		ArrayList<Recipe> recipeList = new ArrayList<Recipe>(); 
		recipeList = cb.getRecipeByArea("Sichuan Dish");//同样的地区 新的area attribute
